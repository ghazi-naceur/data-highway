...
case class SparkConfigs(appName: String, masterUrl: String, generateSuccessFile: Boolean, logLevel: LogLevel)
...
trait SparkUtils extends CassandraUtils {
  ...
  val sparkSession: SparkSession = {
    ...
    ss.sparkContext.hadoopConfiguration
      .set("mapreduce.fileoutputcommitter.marksuccessfuljobs", sparkConf.generateSuccessFile.toString)
    ss
  }
}
