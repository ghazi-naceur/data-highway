...
sealed trait DBConnector extends Input with Output
...
case class Cassandra(keyspace: String, table: String) extends DBConnector
case class Postgres(database: String, table: String) extends DBConnector
