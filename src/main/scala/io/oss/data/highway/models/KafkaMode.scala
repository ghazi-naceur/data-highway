...
case class SparkKafkaPluginConsumer(brokers: String, offset: Offset, dataType: Option[DataType])
    extends KafkaMode
...
case class SparkKafkaPluginProducer(brokers: String, dataType: Option[DataType] = None)
    extends KafkaMode
...
case class PureKafkaProducer(brokers: String, dataType: Option[DataType] = None) extends KafkaMode
