...
object FilesUtils {
   ...
   */
  private[utils] def getFilesFromPath(path: String, extensions: Seq[String]): Either[CsvGenerationError, List[String]] = {
   ...
   */
  private[utils] def listFilesRecursively(path: File, extensions: Seq[String]): Seq[File] = {
   ...
   */
  private[utils] def filterByExtension(file: String, extensions: Seq[String]): Boolean = {
